    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box" id="print-section">
                ...
                <div class="box-body ">
                    <?php
						$attributes = array('id'=>'brand_section','method'=>'post','class'=>'form-horizontal');
					?>
                        <?php echo form_open('sales_report/brand_section',$attributes); ?>
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <?php echo form_label('Select Section:'); ?>
                                    <select name="section_id" class="form-control input-lg select2">
                                        <?php 
                                        if($brands_record != NULL)
                                        {
                                            foreach ($brands_record as $single_brand) 
                                            {
                                        ?>
