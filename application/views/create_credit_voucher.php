<div class="row">
  <div class="col-md-12">
    <ol class="breadcrumb pull-left">
        ...
        <li>
          <a href="<?php echo base_url('vouchers/credit_vouchers'); ?>"> Vouchers</a>
        </li>
        <li class="active">Create credit voucher</li>
    </ol>
  </div> 
</div>
<section class="content">
    <div class="box" id="print-section">
        <div class="box-body ">
            ...
            <?php
                $attributes = array('id'=>'save_credit_voucher','method'=>'post','class'=>'');
            ?>
            <?php echo form_open('vouchers/save_credit_voucher',$attributes); ?>
            <div class="container">
                <div class="row no-print invoice">
                    <h4  class="purchase-heading" > <i class="fa fa-check-circle"></i> 
                      Credit Voucher
                      <small>
                          Voucher is used when receiving cash ( Note: All balances are in <?php  echo $default[0]->currency; ?> ).
                      </small>  
                    </h4>
                    <div class="col-md-12 ">
                        <br>
