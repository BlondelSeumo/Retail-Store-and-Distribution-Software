        ...
        <div class="">
            <div class="box-body">
              <div class="col-md-12">
				...
				?>
				<?php echo form_open_multipart('payee/edit',$attributes); ?>
				<?php 
				 ...
				 ?>
	              	<div class="row box box-default">
	              		<div class="col-md-12 margin">
	              			<h4>
	              				<label class="box-label"><b>Account basic info</b></label>
	              			</h4>
	              	...
	              	<div class="row box box-default">
	              		<div class="col-md-12 margin">
	              			<h4>
	              				<label class="box-label"><b>Account address details</b></label>
	              			</h4>
			              	<div class="col-md-5 field-agjust">	
							   <div class="form-group">
			        ...
			        <div class="row box box-default">
		              ...
		              <div class="col-md-5">	
						  <div class="form-group">  				
							<?php
								$data = array('class'=>'btn btn-info btn-flat btn-lg ','type' => 'submit','name'=>'btn_submit_customer','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Update Account');
