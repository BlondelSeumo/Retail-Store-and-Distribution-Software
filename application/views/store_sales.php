        ...
        <div class="col-xs-12">
            <div class="box" id="print-section">
                ...
                <div class="box-body ">
					...
					?>
                        <?php echo form_open('sales_report/store_wise',$attributes); ?>
                            <div class="col-md-12 no-print">
                                ...
                                <div class="form-group">
                                    <?php echo form_label('Select Store:'); ?>
                                    <select name="store_id" class="form-control input-lg select2">
                                        <?php 
                                        if($store_record != NULL)
                                        {
                                            foreach ($store_record as $single_store) 
                                            {
                                        ?>
