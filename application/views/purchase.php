    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <a class="btn btn-info btn-flat btn-lg" href="<?php echo base_url('purchase/create_purchase');?>" ><i class="fa fa-plus-square" aria-hidden="true"></i> Create Purchase
                </a>
                <a class="btn btn-success btn-flat btn-lg" href="<?php echo base_url('purchase/return_purchase');?>" ><i class="fa fa-arrow-left" aria-hidden="true"></i> Purchase Return
                </a>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <?php
                                    $data = array('class'=>'btn btn-info btn-sm btn-flat margin  pull-right','type' => 'submit','name'=>'searchecord','value'=>'true', 'content' => '<i class="fa fa-search" aria-hidden="true"></i> Search Purchases');
