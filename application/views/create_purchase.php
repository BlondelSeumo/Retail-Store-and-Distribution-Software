    ...
    <div class="box" id="print-section">
        <div class="box-header">
            ...
            <div class="pull pull-right purchase-top-header">
                <a type="button" class="btn btn-info btn-flat btn-sm" onclick="clear_invoice()"  href="#" ><i class="fa fa-eraser" aria-hidden="true"></i> Clear Purchase
                </a>
        ...
        <div class="box-body ">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="purchase-heading"><i class="fa fa-check-circle"></i> Create purchase items :
...
<!-- Bootstrap model  ends--> 
<?php $this->load->view('ajax/purchase_bill_script.php'); ?>