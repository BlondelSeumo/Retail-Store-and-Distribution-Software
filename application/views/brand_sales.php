    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box" id="print-section">
                ...
                <div class="box-body ">
                    <?php
						$attributes = array('id'=>'brand_sales','method'=>'post','class'=>'form-horizontal');
					?>
                        <?php echo form_open('sales_report/brand_sale',$attributes); ?>
                            ...
                            <?php echo form_label('Date From:'); ?>
                                ...
                                <div class="form-group">
                                    <?php echo form_label('Select Brand:'); ?>
                                    <select name="brand_id" class="form-control input-lg select2">
                                        <?php 
