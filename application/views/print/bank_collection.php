...
<section class="content">
    <div class="box" id="print-section">
        <div class="box-body">
            <div class="row" >
                <div class="col-md-12" >
                  <h5  class="purchase-heading" > <i class="fa fa-check-circle"></i>  Bank Collection <span class="pull-right"> <i class="fa fa-calendar"></i>  Date : 
                    <p><?php echo $trans_data[0]->date; ?></p></span>
                      <small>Preview bank collection details</small>
                  </h5>
