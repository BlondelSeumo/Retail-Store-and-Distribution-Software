<section class="content-header">
    <div class="row">
      <ol class="breadcrumb pull-right">
          ...
          <li class="active">Print deposit</li>
      </ol>
    </div> 
    <div class="row">
        <div class="col-md-12">
...
<section class="content">
    <div class="box" id="print-section">
        <div class="box-body">
            <div class="row" >
                <div class="col-md-12" >
                  <h5  class="purchase-heading" > <i class="fa fa-check-circle"></i>  Deposit <span class="pull-right"> <i class="fa fa-calendar"></i>  Date : 
                    <p><?php echo $trans_data[0]->date; ?></p></span>
                      <small>Preview deposit details</small>
                  </h5>
                  <div class="col-md-12 cheque-area-border" >
                    ...
                    <div class="col-md-2" >                        
                      <div class="form-group">
                          ...
                          <p><?php echo $trans_data[0]->total_bill; ?></p>
                      </div>                                         
                    </div>   
                    <div class="col-md-12" >                                      
                      <div class="form-group">
