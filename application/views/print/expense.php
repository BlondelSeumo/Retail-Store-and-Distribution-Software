...
<section class="content" id="print-section">
    <div class="invoice invoice-body">
        ...
        <div class="row"> 
           <div class="col-md-12">
                <h2 class="invoice-title"><b>EXPENSE VOUCHER</b></h2>
           </div> 
       </div> 
       <div class="row set-border-bottom"> 
           ...
           <div class="col-md-4 col-sm-4 pull-right">
                <span class="pull-right">
                    <h4 ><b class="invoice-heading"> EXPENSE  NO </b><span class="pull-right" > <?php echo $expense_data[0]->id; ?></span></h4>
            ...
            <table class="table footer-table">
                   <tr>
                    ...
                    <tr>
                       ...
                       <td> 
                        <?php echo $default_data[0]->currency.' '.$expense_data[0]->total_paid; ?></td>
                   </tr>
                   <tr>
                       <td><b>BALANCE</b></td>
                       <td> 
                        <?php echo $default_data[0]->currency.' '.($subtotal - $expense_data[0]->total_paid); ?></td>
                   </tr>
               </table>
           </div>
       </div>
