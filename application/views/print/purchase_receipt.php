    ...
    <div class="row">
      <div class="col-md-12">
            <ol class="breadcrumb pull-right">
                ...
                <li>
                  <a href="<?php echo base_url('purchase'); ?>"> Purchase receipts</a>
                </li>
           ...
           <div class="col-md-4 col-sm-4 pull-right">
            <table class="table footer-table">
                   ...
                   <tr>
                       ...
                       <td>
                            <?php
                                echo  $single_purchase[0]->discount; 
                            ?>
                       </td>
                   </tr>
                   <tr>
                       ...
                       <td>
                            <?php
                                $discount = ($subtotal / 100) * $single_purchase[0]->discount;
                   ...
                   <tr>
                       <td>PAYMENT DUE <?php echo $default_data[0]->currency; ?></td>
