...
<div class="invoice">
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          ...
          <small>Update you estimate</small>
        </h4>
      </div>
  </section>
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            <?php
                $attributes = array('id'=>'update_estimate','method'=>'post','class'=>'');
            ?>
            <?php echo form_open('estimate/update_estimate',$attributes); ?>
            <div class="row">
                           ...
                           <tfoot>                    
                              <tr>
                                   <td colspan="5">
                                      ...
                                      <button type="button" onclick="clearalllines()" class="btn btn-danger btn-add-setting" name="addline" onclick="add_new_row('<?php echo base_url().'expense/popup/new_bill_row';?>')"> <i class="fa fa-trash"></i>    
                                        Clear all lines 
                                      </button>
                                   </td>
                      ...
                      <div class="col-md-5 ">
                        ...
                        <div class="form-group">
                            ...
                            <?php               
                                ...
                                $data = array('class'=>'','type'=>'hidden','name'=>'estimate_id','value'=>$parent_row[0]->id);
                                echo form_input($data);          
                            ?>
                        </div>
                      </div>                    
