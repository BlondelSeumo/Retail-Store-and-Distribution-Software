        ...
        <div class="col-md-6">
            <div class="pull pull-left">
                <ol class="breadcrumb pull-left">
                    ...
                    <li class="active">Debit vouchers</li>
                </ol>
            </div>
        </div> 
        <div class="col-md-6">
            <div class="pull pull-right">
                <a type="button" class="btn btn-info btn-flat" href="<?php echo base_url('vouchers/debit_voucher'); ?>" ><i class="fa fa-plus-square" aria-hidden="true"></i>        
                    Create Voucher
                </a>
        ...
        <div class="col-xs-12">
            <div class="box" id="print-section">
                ...
                <div class="box-body">
                    ...
                    ?>
                    <?php echo form_open('vouchers/payments',$attributes); ?>
                                    ...
                                    <td>
                                        <div class="btn-group pull no-print pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li ><a href="<?php echo base_url().'prints/debit_voucher/'.$voucher->transaction_id; ?>"><i class="fa fa-link"></i> Preview</a>
                                                </li>
                                                 <li>
                                                    <a  href="<?php echo base_url('vouchers/edit_debit_voucher/'.$voucher->transaction_id); ?>">
...
<script type="text/javascript">
    ...
    {
       window.location = '<?php echo base_url('vouchers/payments/')?>'+period;
    }
</script>
<!-- Bootstrap model  -->
