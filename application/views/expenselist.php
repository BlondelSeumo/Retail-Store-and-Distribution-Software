    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="pull pull-right">
                <a href="<?php echo base_url('expense/add_expense_form'); ?>" class="btn btn-info btn-flat"><i class="fa fa-plus-square" aria-hidden="true"></i>
                ...
                <tbody>
                    <?php
                        ...
                        <tr >
                            ...
                            <td>
                                <?php echo $single_expense->ref_no; ?>
                            </td>                                    
                            <td>
                            ...
                            <div class="btn-group pull no-print pull-right">
                                ...
                                <ul class="dropdown-menu" role="menu">  
                                    ...
                                    <li><a  href="<?php echo base_url().'expense/edit_expense/'.$single_expense->id; ?>">
                        ...
                        <tfoot>
                             <tr>
                                ...
                                <th  colspan="3"><?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?> <?php echo number_format($total_paid,'3','.','') ?></th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
{
    window.location = '<?php echo base_url('expense/index/')?>'+period;
}
</script>
<!-- Bootstrap model  -->
