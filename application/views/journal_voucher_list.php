    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="pull pull-right">
                <a type="button" class="btn btn-info btn-flat" href="<?php echo base_url('vouchers/journal_voucher'); ?>" ><i class="fa fa-plus-square" aria-hidden="true"></i> 
                    Create Voucher
                </a>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box" id="print-section">
                ...
                <div class="box-body">
                <?php
                    $attributes = array('id'=>'journal_list','method'=>'post','class'=>'');
                ?>
                <?php echo form_open('vouchers/journal_list',$attributes); ?>
                                    ...
                                    <td>
                                        <div class="btn-group pull no-print pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li ><a href="<?php echo base_url().'prints/journal_voucher/'.$voucher->transaction_id; ?>"><i class="fa fa-link"></i> Preview</a>
                                                </li>
                                                 <li>
                                                    <a  href="<?php echo base_url('vouchers/edit_journal_voucher/'.$voucher->transaction_id); ?>">
...
<script type="text/javascript">
    ...
    {
       window.location = '<?php echo base_url('vouchers/journal_list/')?>'+period;
    }
 </script>   
<!-- Bootstrap model  -->
