    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <button type="button" onclick="show_modal_page('<?php echo base_url('customers/popup/add_customer_payment_model');?>')" class="btn btn-primary btn-flat btn-lg" ><i class="fa fa-plus-square" aria-hidden="true"></i>  Create Payment
                </button>
                                        ...
                                        <td>
                                            <div class="btn-group pull no-print pull-right">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li onclick="show_modal_page('<?php echo base_url().'customers/popup/edit_customer_payment_model/'.$single_customer->id; ?>')" ><a href="#"><i class="fa fa-pencil"></i> View details</a>
                                                    </li>
